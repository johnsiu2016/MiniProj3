 ...
 */
public class CantoneseDataFragment extends ListFragment implements
        ...
        builder.setTitle(R.string.add_title).setView(addView)
                .setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        values.put(DatabaseHelper.NAME, name.getText().toString());
                        values.put(DatabaseHelper.DESC, desc.getText().toString());
                        values.put(DatabaseHelper.LANG, "cn");
                    ...
                    db
                            ...
                            .query(DatabaseHelper.TABLE,
                                    new String[] {"ROWID AS _id",
                                            DatabaseHelper.NAME,
                                            DatabaseHelper.DESC},
                                    DatabaseHelper.LANG + "= ?", new String[] {"cn"}, null, null, DatabaseHelper.NAME);
